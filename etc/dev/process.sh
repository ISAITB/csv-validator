...
JAR_PATH="/mnt/d/git/itb/csv-validator/csvvalidator-jar/target/validator.jar"
# A temporary folder to be used for processing.
TMP_FOLDER="/mnt/d/_dev/csv/offline/tmp"
# The folder in which the resulting JAR file will be placed.
PROCESSED_FOLDER="/mnt/d/_dev/csv/offline/processed"
# The resource folder used to configure the validator (as would be provided to the validator fot the resource root.
RESOURCE_FOLDER="/mnt/d/git/itb/docker/validator-csv-any"
