...
public class StatisticReportingAspect extends StatisticReporting {
     ...
     */
    @Pointcut("execution(public * eu.europa.ec.itb.csv.web.UploadController.handleUploadMinimal(..))")
     ...
     * Pointcut for minimal WEB validation.
     */
    @Pointcut("execution(public * eu.europa.ec.itb.csv.web.UploadController.handleUploadMinimalEmbedded(..))")
    private void minimalEmbeddedUploadValidation() {}

    /**
     * Pointcut for regular WEB validation.
     */
    @Pointcut("execution(public * eu.europa.ec.itb.csv.web.UploadController.handleUploadEmbedded(..))")
     ...
     */
    @Pointcut("execution(public * eu.europa.ec.itb.csv.rest.RestValidationController.validate(..))")
    private void singleRestValidation(){}

    /**
     * Pointcut for batch REST validation.
     */
    @Pointcut("execution(public * eu.europa.ec.itb.csv.rest.RestValidationController.validateMultiple(..))")
